...
public class AttributeBytes {
    ...
    public AttributeBytes(String attributeName, PublicKey publicKey){
        this(attributeName,publicKey.getPairingParameter().getG0());
    }

    public AttributeBytes(String attributeName, Field G0){
        this.attributeName = attributeName;
        this.attributeValue = G0.newElementFromBytes(attributeName.getBytes(StandardCharsets.UTF_8)).getImmutable().toBytes();
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof AttributeBytes)) {
            return false;
        }

        AttributeBytes attribute1 = (AttributeBytes) o;
