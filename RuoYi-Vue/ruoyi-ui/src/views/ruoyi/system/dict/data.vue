...
<script>
import { listData, getData, delData, addData, updateData } from '@/api/ruoyi/system/dict/data'
import { optionselect as getDictOptionselect, getType } from '@/api/ruoyi/system/dict/type'
